...
type transactionValidator struct {
	...
	burnBase                                uint64 // Rupix: burn por tx (base)
	burnPerByte                             uint64 // Rupix: burn por tx (por byte)
}
...
func New(blockCoinbaseMaturity uint64,
	...
	burnBase uint64,
	burnPerByte uint64) model.TransactionValidator {
