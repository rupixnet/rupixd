...
// SignatureScript creates an input signature script for tx to spend RUPIX sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend RUPIX sent
