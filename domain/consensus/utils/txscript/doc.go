/*
Package txscript implements the rupix transaction script language.

This package provides data structures and functions to parse and execute
rupix transaction scripts.

# Script Overview

rupix transaction scripts are written in a stack-base, FORTH-like language.

The rupix script language consists of a number of opcodes which fall into
...
Typical rupix scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend rupix.
