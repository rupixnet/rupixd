...
import (
	...
	"github.com/rupixnet/rupixd/domain/consensus/processes/blockparentbuilder"
	...
	"github.com/rupixnet/rupixd/domain/consensus/datastructures/blockstore"
	...
	"github.com/rupixnet/rupixd/domain/consensus/datastructures/utxodiffstore"
	"github.com/rupixnet/rupixd/domain/consensus/model/externalapi"
	"github.com/rupixnet/rupixd/domain/consensus/model/testapi"
	"github.com/rupixnet/rupixd/domain/consensus/processes/blockbuilder"
	"github.com/rupixnet/rupixd/domain/consensus/processes/blockprocessor"
	"github.com/rupixnet/rupixd/domain/consensus/processes/blockvalidator"
	"github.com/rupixnet/rupixd/domain/consensus/processes/coinbasemanager"
	"github.com/rupixnet/rupixd/domain/consensus/processes/consensusstatemanager"
	...
	"github.com/rupixnet/rupixd/domain/consensus/processes/difficultymanager"
	"github.com/rupixnet/rupixd/domain/consensus/processes/finalitymanager"
	"github.com/rupixnet/rupixd/domain/consensus/processes/ghostdagmanager"
	"github.com/rupixnet/rupixd/domain/consensus/processes/headersselectedtipmanager"
	"github.com/rupixnet/rupixd/domain/consensus/processes/mergedepthmanager"
	"github.com/rupixnet/rupixd/domain/consensus/processes/pastmediantimemanager"
	"github.com/rupixnet/rupixd/domain/consensus/processes/pruningmanager"
...
func (f *factory) NewConsensus(config *Config, db infrastructuredatabase.Database, dbPrefix *prefix.Prefix,
	...
	if pruningWindowSizeForCaches > 200000 {
		pruningWindowSizeForCaches = 200000
	}
	...
	if pruningWindowSizePlusFinalityDepthForCache > 400000 {
		pruningWindowSizePlusFinalityDepthForCache = 400000
	}
	...
	transactionValidator := transactionvalidator.New(config.BlockCoinbaseMaturity,
		...
		daaBlocksStore,
		txMassCalculator,
                config.LevelDiamanteUnlockScore,
                config.LevelPlatinoUnlockScore,
                config.LevelRodioUnlockScore,
                config.LevelKingsUnlockScore)
