...
type BlockProcessor interface {
	...
	ValidateAndInsertBlockAsTrusted(block *externalapi.DomainBlock, shouldValidateAgainstUTXO bool) (*externalapi.VirtualChangeSet, externalapi.BlockStatus, error)
