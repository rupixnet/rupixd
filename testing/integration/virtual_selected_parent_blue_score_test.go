...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := rupixd.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = rupixd.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = rupixd.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
