...
type grpcStream interface {
	Send(*protowire.RupixdMessage) error
	Recv() (*protowire.RupixdMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.RupixdMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.RupixdMessage) error {
