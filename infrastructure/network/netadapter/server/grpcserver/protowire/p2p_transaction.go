...
func (x *RupixdMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "RupixdMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *RupixdMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
