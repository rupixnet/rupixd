...
func (x *RupixdMessage_RequestBlockLocator) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *RupixdMessage_RequestBlockLocator) fromAppMessage(msgGetBlockLocator *appmessage.MsgRequestBlockLocator) error {
