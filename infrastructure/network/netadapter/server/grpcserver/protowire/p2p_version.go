...
func (x *RupixdMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "RupixdMessage_Version is nil")
	}
...
func (x *RupixdMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
