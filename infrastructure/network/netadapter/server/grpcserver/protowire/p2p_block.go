...
func (x *RupixdMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "RupixdMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *RupixdMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
