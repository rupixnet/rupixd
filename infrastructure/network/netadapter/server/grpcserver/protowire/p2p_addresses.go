...
func (x *RupixdMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "RupixdMessage_Addresses is nil")
	}
...
func (x *RupixdMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
