...
type P2P_MessageStreamClient interface {
	Send(*RupixdMessage) error
	Recv() (*RupixdMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *RupixdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*RupixdMessage, error) {
	m := new(RupixdMessage)
...
func (x *p2PMessageStreamServer) Send(m *RupixdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*RupixdMessage, error) {
	m := new(RupixdMessage)
...
func (x *rPCMessageStreamClient) Send(m *RupixdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*RupixdMessage, error) {
	m := new(RupixdMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *RupixdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*RupixdMessage, error) {
	m := new(RupixdMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
