/*
Package addressmanager implements concurrency safe rupix address manager.

# Address Manager Overview

In order maintain the peer-to-peer rupix network, there needs to be a source
of addresses to connect to as nodes come and go. The rupix protocol provides
