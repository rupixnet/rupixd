...
// installService attempts to install the rupixd service. Typically this should
...
// removeService attempts to uninstall the rupixd service. Typically this should
...
// startService attempts to Start the rupixd service.
