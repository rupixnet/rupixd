...
// MsgDoneHeaders implements the Message interface and represents a rupix
...
// NewMsgDoneHeaders returns a new rupix DoneIBDBlocks message that conforms to the
// Message interface.
