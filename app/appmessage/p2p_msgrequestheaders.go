...
// MsgRequestHeaders implements the Message interface and represents a rupix
...
// NewMsgRequstHeaders returns a new rupix RequestHeaders message that conforms to the
