...
// MsgRequestTransactions implements the Message interface and represents a rupix
...
// NewMsgRequestTransactions returns a new rupix RequestTransactions message that conforms to
