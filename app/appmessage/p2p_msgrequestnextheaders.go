...
// MsgRequestNextHeaders implements the Message interface and represents a rupix
...
// NewMsgRequestNextHeaders returns a new rupix RequestNextHeaders message that conforms to the
// Message interface.
