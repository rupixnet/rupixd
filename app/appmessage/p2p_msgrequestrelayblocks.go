...
// MsgRequestRelayBlocks implements the Message interface and represents a rupix
...
// NewMsgRequestRelayBlocks returns a new rupix RequestRelayBlocks message that conforms to
