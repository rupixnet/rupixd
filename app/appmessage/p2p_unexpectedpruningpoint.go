...
// MsgUnexpectedPruningPoint represents a rupix UnexpectedPruningPoint message
...
// NewMsgUnexpectedPruningPoint returns a new rupix UnexpectedPruningPoint message
