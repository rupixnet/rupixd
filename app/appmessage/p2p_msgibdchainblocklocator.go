...
// MsgIBDChainBlockLocator implements the Message interface and represents a rupix
...
// NewMsgIBDChainBlockLocator returns a new rupix locator message that conforms to
