...
// MsgTransactionNotFound defines a rupix TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new rupix transactionsnotfound message that conforms to the
