...
var DefaultUserAgent = fmt.Sprintf("/rupixd:%s/", version.Version())

// MsgVersion implements the Message interface and represents a rupix version
...
// NewMsgVersion returns a new rupix version message that conforms to the
