...
// RPCTransaction is a rupixd transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a rupixd transaction input representation
...
// RPCScriptPublicKey is a rupixd ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a rupixd transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a rupixd outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a rupixd utxo entry representation meant to be used
// over RPC
