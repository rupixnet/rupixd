/*
Package util provides rupix-specific convenience functions and types.

# Block Overview

A Block defines a rupix block that provides easier and more efficient
...
A Tx defines a rupix transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a rupix address. While the
most common type is a pay-to-pubkey, rupix already supports others and
...
To decode/encode an address:
	...
	addrString := "rupix:qqj9fg59mptxkr9j0y53j5mwurcmda5mtza9n6v9pm9uj8h0wgk6uma5pvumr"
